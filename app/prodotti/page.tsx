...
export default function ProdottiPage() {
    ...
    return (
        <div className="min-h-screen py-12 md:py-20 lux-shell" style={{ backgroundColor: 'var(--color-background)' }}>
            <div className="container mx-auto px-4">
                <div className="section-wrap p-6 sm:p-8 md:p-10 mb-10 md:mb-12">
                ...
                {loading ? (
                    <div className="pb-6">
                        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-6 md:gap-8" aria-hidden="true">
                            {Array.from({ length: 10 }).map((_, index) => (
                                ...
                                >
                                    <div className="aspect-square" style={{ backgroundColor: 'rgba(255,255,255,0.06)' }} />
                                    <div className="p-4 space-y-3">
                                        <div className="h-3 w-20 rounded" style={{ backgroundColor: 'rgba(255,255,255,0.1)' }} />
                                        <div className="h-5 w-2/3 rounded" style={{ backgroundColor: 'rgba(255,255,255,0.12)' }} />
                                        <div className="h-3 w-full rounded" style={{ backgroundColor: 'rgba(255,255,255,0.08)' }} />
                                        <div className="h-9 w-full rounded-lg" style={{ backgroundColor: 'rgba(255,255,255,0.14)' }} />
                                    </div>
                                </div>
                            ))}
                        </div>
                        <p className="text-center mt-6" style={{ color: 'var(--color-text)', opacity: 0.7 }}>{t('loading')}</p>
                    </div>
                ) : (
                    <>
                        {/* Griglia Prodotti */}
